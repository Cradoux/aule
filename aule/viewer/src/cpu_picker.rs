...
use aule_geo::{
	barycentrics_plane, build_face_table, lattice_from_ab, one_hop_rollover, pick_face, sph_to_unit as sph_to_unit_geo,
...
impl Vec3 {
	...
	#[inline] pub fn norm(self)->Self{ let l=(self.x*self.x+self.y*self.y+self.z*self.z).sqrt();
...
pub struct FaceTri {
	pub face: FaceId,
	pub tri: u32,
	pub u: u32, pub v: u32, pub upper: bool,
	pub w: [f32;3], pub kneg: u32,
}

pub struct GeoPicker { faces: Vec<FaceGeom> }
impl GeoPicker {
	pub fn new() -> Self { Self { faces: build_face_table() } }
	#[inline] pub fn faces(&self)->&[FaceGeom]{ &self.faces }
